...
public class RobotContainer {
  ...
  public void registerNamedCommands(){
    NamedCommands.registerCommand("launch", new RunCommand(() -> m_launcher.runLauncher()).withTimeout(2.0));
    NamedCommands.registerCommand("launch1", new InstantCommand(() -> m_launcher.runLauncher()));

    NamedCommands.registerCommand("stopLaunch", new InstantCommand(() -> m_launcher.stopLauncher()));
    NamedCommands.registerCommand("intake", new InstantCommand(() -> m_intake.feedLauncher(m_launcher)));
    NamedCommands.registerCommand("stopIntake", new InstantCommand(() -> m_launcher.stopLauncher()));
