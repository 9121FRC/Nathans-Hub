...
public final class Constants {
  ...
  public static final class Arm {
    ...
    //was -1.15
    public static final double kSoftLimitReverse = -1.25;
    //was 0.0
    public static final double kSoftLimitForward = 0.2;

    public static final double kArmGearRatio = (1.0 / 25.0) * (28.0 / 50.0) * (16.0 / 64.0)/5;
    public static final double kPositionFactor =
        kArmGearRatio
            * 2.0
            * Math.PI; // multiply SM value by this number and get arm position in radians

    //change velocityFactor or ArmFreeSpeed to divide by 5       
    public static final double kVelocityFactor = kArmGearRatio/2 * 2.0 * Math.PI / 60.0;
    public static final double kArmFreeSpeed = 5676.0 * kVelocityFactor/2;
    ...
    public static final TrapezoidProfile.Constraints kArmMotionConstraint =
        new TrapezoidProfile.Constraints(1.5, 3.5);
  ...
  public static final class Launcher {
    ...
    public static final double kTopPower = 8;
    public static final double kBottomPower = 8;
  }
